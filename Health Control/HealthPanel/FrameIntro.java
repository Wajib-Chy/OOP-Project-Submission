...
public class FrameIntro extends JFrame implements ActionListener, MouseListener 
{
    ...
    private JButton bmiBtn, dietBtn, waterBtn, exitBtn, saveBtn, showHistoryBtn, deleteHistoryBtn;
	...
	{
        super("Bhai-bhai Health Assistant");
        setSize(1000, 700);
        setLayout(null);
        ...
        exitBtn = createButton("Exit", 135, 560);
        showHistoryBtn = createButton("Show History", 60, 500);
        deleteHistoryBtn = createButton("Delete History", 210, 500);
        ...
        background.add(showHistoryBtn);
        background.add(deleteHistoryBtn);
        ...
        showHistoryBtn.addMouseListener(this);
        deleteHistoryBtn.addActionListener(this);
        deleteHistoryBtn.addMouseListener(this);
    }
        ...
        try 
		{
			...
			else if (src == showHistoryBtn) 
			{
				...
				
				{
                    ...
                    resultArea.setText(history.isEmpty() ? "No history found." : history);
                } 
				catch (Exception ex) 
				{
                    resultArea.setText("Error reading history.");
                }
 
            } 
			else if (src == deleteHistoryBtn) 
			{
